...
import { decreaseVal } from '../../../dataDecreaser'
...
const UEVASuitDisplay: React.FC<EVASDProps> = (props) => {
    ...
    useEffect(() => {
        ...
        const id = setInterval(() => {
            var newValues = {
                eva1: {
                    helmetPressure: generateRandVal(60, 80).toFixed(2),
                    o2: decreaseVal(80),
                    water: generateRandVal(60, 80).toFixed(2),
                    batteryCharge: generateRandVal(60, 80).toFixed(2),
                    pressure: generateRandVal(60, 80).toFixed(2)
                },
    ...
    return (
        ...
        <div className={props.className}>
            <svg preserveAspectRatio='xMidYMid meet' viewBox='0 0 1400 1000'>
                ...
                <text x="37%" y="18%" fill="#EBB249" fontSize="30" text-decoration="underline"> Helmet Pressure (psi)</text> 
                <line x1="47%" y1="20%" x2="47%" y2="30%" stroke="#a39d9d" strokeWidth="4" />
                
                <text x="41%" y="34%" fill="#EBB249" fontSize="30" text-decoration="underline"> O2 Level (%)</text>
                ...
                <text x="37%" y="66%" fill="#EBB249" fontSize="30" text-decoration="underline"> Battery Chrage Level (%)</text>
                <line x1="47%" y1="68%" x2="47%" y2="75%" stroke="#a39d9d" strokeWidth="4" />

                <text x="43.5%" y="78%" fill="#EBB249" fontSize="30" text-decoration="underline"> Pressure</text>
                <line x1="47%" y1="80%" x2="47%" y2="89%" stroke="#a39d9d" strokeWidth="4" />

                <text x="43.5%" y="92%" fill="#EBB249" fontSize="30" text-decoration="underline"> Comms</text>
                <line x1="47%" y1="94%" x2="47%" y2="98%" stroke="#a39d9d" strokeWidth="4" />
