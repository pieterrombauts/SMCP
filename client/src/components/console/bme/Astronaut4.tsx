...
const Astronaut4: React.FC<A4Props> = ( props ) => {
  return(
    <g id="bme-vital-signs-astronaut1">
      ...
      <image x="72%" y="59.5%" width={150} height={150} href='/media/Bme_1.gif'></image>
      ...
      <text x="72%" y="79.5%" fill="#7ef56e" fontSize="20" fontFamily="Verdana">{props.values.astronaut4.bloodPressureSystolic} / </text>
      <text x="77.5%" y="79.5%" fill="#7ef56e" fontSize="20" fontFamily="Verdana">{props.values.astronaut4.bloodPressureDiastolic}</text>
